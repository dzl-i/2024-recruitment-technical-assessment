...
import UnilectivesIcon from "../assets/unilectives.svg";
import {
  BookOpenIcon,
  ShieldCheckIcon,
  BarsArrowUpIcon,
...
export const Navbar = () => {
  return (
    <div className="fixed flex flex-col items-center w-20 h-screen gap-4 p-4" style={{ backgroundColor: "#f5f5f5" }}>
      <div className="flex items-center h-10 p-2">
        <Image
          src={UnilectivesIcon}
